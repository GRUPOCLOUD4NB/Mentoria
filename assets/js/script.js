...
document.addEventListener("DOMContentLoaded", function () {
    const bookingButtons = document.querySelectorAll(".apt-btn"); // Botões de "Agendar consulta"
    
    bookingButtons.forEach(button => {
        button.addEventListener("click", function (event) {
            event.preventDefault(); // Evita comportamento padrão

            // Verifica se o usuário está logado (ajuste de acordo com a sua implementação)
            ...
            if (isLoggedIn) {
                ...
                // Salva a página de destino e redireciona para login
    ...
    // Gerencia o redirecionamento após login na página login.html
    const loginButton = document.querySelector(".login-btn");
    if (loginButton) {
        loginButton.addEventListener("click", function (event) {
            event.preventDefault();

            // Simula login (troque por uma chamada de API ou lógica real)
            localStorage.setItem("isLoggedIn", true);

            // Redireciona para a página salva ou página inicial
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const logoutButton = document.querySelector(".logout-btn"); // Botão de logout (ajuste o seletor, se necessário)
    if (logoutButton) {
    ...
    // Proteção contra acesso direto a booking.html sem login
